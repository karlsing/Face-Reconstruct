...
import numpy as np
import torch
from model.cldm.model import create_model
...
def main():
  nc, dc = parse_args_and_config()
  set_random_seed(nc.args.seed)
  nc.training.use_DDP = False
  nc.training.local_rank = 2
  nc.training.device = [torch.device("cuda:2")]
  runner = get_runner(nc.runner, nc)
  runner.train()
